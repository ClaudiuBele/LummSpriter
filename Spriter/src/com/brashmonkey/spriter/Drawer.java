...
public abstract class Drawer<R> {
	 ...
	 * @param player the player to draw
	 */
	public void draw(Player player, LummSceneLayer sceneLayer){
		this.draw(player, player.characterMaps,sceneLayer);
	}
	 ...
	 */
	public void draw(Player player, CharacterMap[] maps, LummSceneLayer sceneLayer){
		this.draw(player, player.objectIterator(), maps,sceneLayer);
	}
	 ...
	 * @param map the character map to draw
	 */
	public void draw(Player player, Iterator<Timeline.Key.Object> it, CharacterMap[] maps, LummSceneLayer sceneLayer){
		while(it.hasNext()){
			...
			if(object.ref.hasFile()){
				...
				this.draw(player, object,sceneLayer);
			}
		}
	}
	 ...
	 */
	public abstract void draw(Player player, Timeline.Key.Object object,  LummSceneLayer sceneLayer);
}
